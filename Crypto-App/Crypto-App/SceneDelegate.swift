...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let favoriteViewModel = FavoriteMenuViewModel()
        favoriteCoinsVC.favoriteMenuViewModel = favoriteViewModel
        
        let detailsViewModel = DetailsViewModel() // DetailsViewModel'ı oluşturun
        guard let detailsVC = storyboard.instantiateViewController(withIdentifier: "DetailsPageViewController") as? DetailsViewController else {
